...
import { ButtonsConfig, ButtonsStrategy, ButtonType, Image, ModalGalleryConfig, ModalGalleryRef, ModalGalleryService, ModalLibConfig, PlainGalleryConfig, PlainGalleryStrategy } from "@ks89/angular-modal-gallery";
...
@Component({
  ...
  styleUrls: ['./service-landing-page.component.css']
})
export class ServiceLandingPageComponent implements OnInit, OnDestroy {
  ...
  openModal(id: number, imageIndex: number, buttonsConfig: ButtonsConfig): void {
    const dialogRef: ModalGalleryRef = this.modalGalleryService.open({
      id: id,
      images: this.serviceGalleryPopup,
      currentImage: this.serviceGalleryPopup[imageIndex],
      libConfig: {
